...
const orm_1 = __importStar(require("./src/db/orm"));
const user = {
    username: "johndoe",
    password: 'nice',
...
const sa = () => __awaiter(void 0, void 0, void 0, function* () {
    const newuser = new orm_1.User(user);
    const newUser = new orm_1.default(newuser);
    yield newUser.save();
});
sa();
